    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) text-white hover:text-white aria-disabled:opacity-50 p-0 select-none",
        ...
        dropdown_root: cn(
          "relative bg-background text-white border border-white/20 rounded-md shadow-md",
          defaultClassNames.dropdown_root,
        ),

        dropdown: cn(
          "absolute inset-0 opacity-0 bg-white text-black",
        ...
        today: cn(
          "border border-blue-500 text-white rounded-md",
    ...
    <Button
      ...
      className={cn(
        "text-white " +
          ...
          "data-[range-middle=true]:bg-blue-500/30 data-[range-middle=true]:text-white " +
